...
class Profile(TimestampedModel):
    ...
    # relationship are of the same model. In this case, the model is 'Profiles'.
    # As mentionedin the text, this relationship will be one-way. Just because
    ...
    def unfollow(self, profile):
        """Unfollow 'profile' if we're alread following  'profile'."""
